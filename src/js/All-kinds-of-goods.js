        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < result.length; i++) {
                    ...
                    node += "<a href='particulars.html'><div class='shop'><div class='img-box'><img src='" + result[i].imgurl + "' alt=''></div><div class='explain'><p class='name'>" + result[i].listname + "</p><p class='price'><span class='now'>￥" + result[i].pointPrice + "</span><span class='before'>￥" + result[i].maxPrice + "</span></p></div></div></a>"
                    $('.content2').html(node);
                }
            }
        })
                    ...
                    if (flage) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                for (var i = 0; i < result.length; i++) {
                                    // var node = $('.content2').html();
                                   var node = "<a href='particulars.html'><div class='shop'><div class='img-box'><img src='" + result[i].imgurl + "' alt=''></div><div class='explain'><p class='name'>" + result[i].listname + "</p><p class='price'><span class='now'>￥" + result[i].pointPrice + "</span><span class='before'>￥" + result[i].maxPrice + "</span></p></div></div></a>"
                                    if(!no_off){
